            ...
            <li className={`${dashBoard.includes(path) ? "mm-active" : ""}`}>
              <Link className={`${path === "" ? "mm-active" : ""}`} to="/" onClick={() => this.props.onClick3()}>
				...
				{/* <ul >
					...
					<li>
						<Link className={`${path === "patient-details" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/patient-details" >
							 Patient Details
						</Link>
					</li>
					<li>
            ...
            {/* <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              ...
              <ul > */}
                <li>
					...
					<Link className={`${path === "app-profile" ? "mm-active" : ""}`} onClick={() => this.props.onClick()} to="/app-profile">
          <i className="flaticon-381-user-1"></i><span className="nav-text">My Profile</span></Link>
                </li>
				        {/* <li>
                ...
                <li>
                  <Link
                    className={`${path === "app-schedule" ? "mm-active" : ""}`}
                    onClick={() => this.props.onClick()}
                    to="/app-schedule"
                  >
                    <i className="flaticon-381-calendar-7"></i>
            ...
            {/* <li className={`${redux.includes(path) ? "mm-active" : ""}`}>
                ...
                <ul> */}
                    { this.userRole === 'DN' && <li><Link className={`${path === "Requests" ? "mm-active" : ""}`} to="/Requests"><i className="flaticon-381-list"></i><span className="nav-text"> Requests List</span></Link></li>}
                    {this.userRole !== 'DN' &&<li><Link className={`${path === "Appointments" ? "mm-active" : ""}`} to="/Appointments"><i className="flaticon-381-list"></i><span className="nav-text"> My Appointments List</span></Link></li>}
			...
			<div className="plus-box">
                  ...
                  <Link to={"/app-schedule"} className="text-white fs-26" >
                     <i className="las la-long-arrow-alt-right" />
                  </Link>
               </div>
			<div className="copyright">
				<p>
				  <strong>Dardotechs</strong> © 2023 All
				  Rights Reserved
				</p>
			  </div>
			</PerfectScrollbar>
