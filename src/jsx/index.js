...
import Todo from './components/AppointmentsList/Todo';
import RequestsTable from './components/RequestsList/RequestsTable';
//Scroll To Top
...
const Markup = () => {
  ...
  const routes = [
    ...
    { url: 'app-schedule', component: Calendar },
    ...
    { url: 'Appointments', component: Todo },
    {url:'Requests', component: RequestsTable},
  ]
