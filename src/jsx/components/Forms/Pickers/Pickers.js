...
import { DateTimePicker, DatePicker, DateRangePicker } from '@mui/lab';
// import AdapterDateFns from "@mui/lab/AdapterDateFns/AdapterDateFns";
// import { DatePicker } from '@mui/x-date-pickers/DatePicker';
// import { DateRangePicker } from '@mui/x-date-pickers-pro/DateRangePicker';
// import { DateRangePicker } from '@mui/lab-date-picker-react';
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="row">
                ...
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <div className="example rangeDatePicker">
                    <p className="mb-1">Date Range Pick with time</p>
