...
const Home = () => {
   ...
   const [clicked, setClicked]=useState("monthly");
                  ...
                  <div className="card-body">
                     <div className="media align-items-center">
                        <div className="media-body">
                           <p className="mb-1">Total Pregnant Women</p>
            ...
            <div className="col-xl-3 col-xxl-4 col-lg-4">
               <div className="card">
                  <div className="card-header border-0 pb-0">
                     <h3 className="fs-20 mb-0 text-black">Number Of confirmed Appointment by Year</h3>
                  ...
                  <div className="card">
                     <div className="card-header d-sm-flex d-block border-0 pb-0">
                        <h3 className="fs-20 mb-3 mb-sm-0 text-black">
                           Patient Appointments Statistic
                        </h3>
